...
def make_inference_cmd(
    ...
    character: str = typer.Option(default="claudy", help="Character to use for inference"),
    ...
    inference_engine = InferenceEngine(logger=logger, input=input, tuned=tuned, character=character)
